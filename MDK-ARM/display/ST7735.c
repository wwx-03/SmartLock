...
#if defined USE_LCD_DRIVER_ST7735
...
int LCD_AddressSet(lcd_handle_t *handle, uint16_t xs, uint16_t xe, uint16_t ys, uint16_t ye)
{
	...
	LCD_WriteData8(handle, (xs + 2) >> 8);
	LCD_WriteData8(handle, (xs + 2));
	LCD_WriteData8(handle, (xe + 2) >> 8);
	LCD_WriteData8(handle, (xe + 2));
	LCD_WriteCommand(handle, ROW_ADDRESS_SET);
	LCD_WriteData8(handle, (ys + 1) >> 8);
	LCD_WriteData8(handle, (ys + 1));
	LCD_WriteData8(handle, (ye + 1) >> 8);
	LCD_WriteData8(handle, (ye + 1));
...
int LCD_DrawLine(void *handle, uint16_t x1,uint16_t x2,uint16_t y1,uint16_t y2)
{
	...
	{
		LCD_DrawPoint(handle, uRow,uCol);
		xerr+=delta_x;
		yerr+=delta_y;
		if(xerr>distance)
		{
...
{
	LCD_DrawLine(handle, x1,x2,y1,y1);
	LCD_DrawLine(handle, x1,x1,y1,y2);
	LCD_DrawLine(handle, x1,x2,y2,y2);
	LCD_DrawLine(handle, x2,x2,y1,y2);
	return 0;
}
...
int LCD_Init(lcd_handle_t *handle, lcd_init_t *initStructure)
{
  ...
  handle->pen = initStructure->pen;
	...
	//------------------------------------ST7735S Frame Rate-----------------------------------------// 
	LCD_WriteCommand(handle, 0xB1); 
	LCD_WriteData8(handle, 0x05); 
	LCD_WriteData8(handle, 0x3C); 
	LCD_WriteData8(handle, 0x3C); 
	LCD_WriteCommand(handle, 0xB2); 
	LCD_WriteData8(handle, 0x05);
	LCD_WriteData8(handle, 0x3C); 
	LCD_WriteData8(handle, 0x3C); 
	LCD_WriteCommand(handle, 0xB3); 
	LCD_WriteData8(handle, 0x05); 
	LCD_WriteData8(handle, 0x3C); 
	LCD_WriteData8(handle, 0x3C); 
	LCD_WriteData8(handle, 0x05); 
	...
	LCD_WriteCommand(handle, 0xB4); //Dot inversion 
	LCD_WriteData8(handle, 0x03); 
	//------------------------------------ST7735S Power Sequence---------------------------------// 
	LCD_WriteCommand(handle, 0x00); 
	LCD_WriteData8(handle, 0x28); 
	LCD_WriteData8(handle, 0x08); 
	LCD_WriteData8(handle, 0x04); 
	LCD_WriteCommand(handle, 0xC1); 
	LCD_WriteData8(handle, 0XC0); 
	LCD_WriteCommand(handle, 0xC2); 
	LCD_WriteData8(handle, 0x0D); 
	LCD_WriteData8(handle, 0x00); 
	LCD_WriteCommand(handle, 0xC3); 
	LCD_WriteData8(handle, 0x8D); 
	LCD_WriteData8(handle, 0x2A); 
	LCD_WriteCommand(handle, 0xC4); 
	LCD_WriteData8(handle, 0x8D); 
	LCD_WriteData8(handle, 0xeE); 
	//---------------------------------End ST7735S Power Sequence-------------------------------------// 
	LCD_WriteCommand(handle, 0xC5); //VCOM 
	LCD_WriteData8(handle, 0x1A); 
	LCD_WriteCommand(handle, 0x36); //MX, MY, RGB mode 
	LCD_WriteData8(handle, 0x00);
	//------------------------------------ST7735S Gamma Sequence---------------------------------// 
	LCD_WriteCommand(handle, 0xe0); 
	LCD_WriteData8(handle, 0x04); 
	LCD_WriteData8(handle, 0x22); 
	LCD_WriteData8(handle, 0x07); 
	LCD_WriteData8(handle, 0x0A); 
	LCD_WriteData8(handle, 0x2E); 
	LCD_WriteData8(handle, 0x30); 
	LCD_WriteData8(handle, 0x25); 
	LCD_WriteData8(handle, 0x2A); 
	LCD_WriteData8(handle, 0x28); 
	LCD_WriteData8(handle, 0x26); 
	LCD_WriteData8(handle, 0x2E); 
	LCD_WriteData8(handle, 0x3A); 
	LCD_WriteData8(handle, 0x00); 
	LCD_WriteData8(handle, 0x01); 
	LCD_WriteData8(handle, 0x03); 
	LCD_WriteData8(handle, 0x13); 
	LCD_WriteCommand(handle, 0xe1); 
	LCD_WriteData8(handle, 0x04); 
	LCD_WriteData8(handle, 0x16); 
	LCD_WriteData8(handle, 0x06); 
	LCD_WriteData8(handle, 0x0D); 
	LCD_WriteData8(handle, 0x2D); 
	LCD_WriteData8(handle, 0x26); 
	LCD_WriteData8(handle, 0x23); 
	LCD_WriteData8(handle, 0x27); 
	LCD_WriteData8(handle, 0x27); 
	LCD_WriteData8(handle, 0x25); 
	LCD_WriteData8(handle, 0x2D); 
	LCD_WriteData8(handle, 0x3B); 
	LCD_WriteData8(handle, 0x00); 
	LCD_WriteData8(handle, 0x01); 
	LCD_WriteData8(handle, 0x04); 
	LCD_WriteData8(handle, 0x13); 
	...
	LCD_WriteData8(handle, 0x05); 
	LCD_WriteCommand(handle, 0x29); //Display on 
