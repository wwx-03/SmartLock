...
void HAL_UART_TxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  else if(huart == &huart3)
  {
    ...
    memset(rx3Buffer, '\0', sizeof(rx3Buffer));
    HAL_UARTEx_ReceiveToIdle_DMA(&huart3, rx3Buffer, sizeof(rx3Buffer) / sizeof(rx3Buffer[0]));
...
void HAL_UARTEx_RxEventCallback(UART_HandleTypeDef *huart, uint16_t Size)
{
  ...
  else if(huart == &huart3)
  {
    ...
    HAL_UART_Transmit(&huart1, rx3Buffer, strlen((char *)rx3Buffer), HAL_MAX_DELAY);
    /* Test functional end  */
  }
}
/* USER CODE END 1 */
